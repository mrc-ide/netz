...
convert_usage_to_annual_nets_distributed <- function(target_usage, distribution_freq = 3*365,
  ...
  usage_to_npc <- convert_usage_to_npc(target_usage = target_usage,
  ...
  nets_distributed <- convert_npc_to_annual_nets_distributed(usage_to_npc_output=usage_to_npc, 
...
convert_usage_to_npc <- function(target_usage,
  ...
  if(extrapolate_npc == "linear") {
    ...
    loess_for_prediction <- rbind(access_vs_npc_data,
    ...
    curve_fit <- loess(access ~ percapita_nets, data=access_vs_npc_data,
...
convert_npc_to_annual_nets_distributed <- function(usage_to_npc_output, 
  ...
  nets_distributed <- merge(x=usage_to_npc_output, y=half_life_data[,c("iso3", "half_life")], 
  ...
  nets_distributed <- nets_distributed[,c("iso3", "use_rate", "half_life", "distribution_freq", "target_use", 
