...
find_annual_nets_distributed <- function(target_usage, country_iso3="all", 
  ...
  # Use net loss function to calculate annual nets distributed per capita for different countries 
  # and target usages
...
find_usage <- function(annual_percapita_nets_distributed, country_iso3="all", 
  ...
  # Use the net loss function to calculate th equilibrium nets per capita for the given
...
#' @param t Single value or vector of timesteps.
#' @param k Fixed rate. Default = 20 from Bertozzi-Villa, Amelia, et al. Nature communications 12.1 (2021): 1-12.
#' @param l Country-specific time at which no nets are retained (nets=0).
...
#' Integrate net loss function between 0 and 3
#' @param k Fixed rate. Default = 20 from Bertozzi-Villa, Amelia, et al. Nature communications 12.1 (2021): 1-12.
#' @param l Country-specific time at which no nets are retained (nets=0).
#' @export
...
#' Vectorise function for integration of net loss
#' Allows application on multiple countries/vector of half-lives
#' @inheritParams integrate_net_loss
#' @export
