...
one "loess" a loess smooth of the observed data, a second "loess_extrpolate" a loess smooth of the observed data witht the trend
extrapolted to allow prediction for access values outside of the observed range and a third "linear" a linear fit to the lower (access < 0.5) set of observed values. This last model is very simple and does not fit the observed data well, so use with caution. 
